  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 mt-2">If you're not redirected automatically, <a href={shortLink.original_url} className="text-orange-600 hover:underline">click here</a></p>
      </div>
    </div>
  );
};
