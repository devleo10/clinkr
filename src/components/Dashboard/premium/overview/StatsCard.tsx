  ...
  >
    ...
    <div className="flex justify-between items-start relative z-10">
      <div>
        ...
        <h3 className="text-2xl font-bold mt-1 text-indigo-700">{value}</h3>
      </div>
      <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 text-indigo-600 shadow-md">
        {icon}
      </div>
    </div>
